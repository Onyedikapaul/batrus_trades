(function () {
    ...
    tbody.innerHTML = users
      .map((u) => {
        ...
        <tr>
          ...
          <td>
            <label class="toggle">
              <input type="checkbox" ${u.isAllowedToWithdraw ? "checked" : ""}
                data-user-id="${esc(u._id)}" data-type="withdraw" />
              <span class="toggle-slider"></span>
            </label>
          </td>
    ...
    tbody.querySelectorAll("[data-login-id]").forEach((btn) => {
      btn.addEventListener("click", async () => {
        ...
        try {
          ...
          window.location.href = data.redirectUrl || "/account/index.html";
        } catch (err) {
  ...
  //   document
  //     .getElementById("amAddWithdrawBtn")
  //     ?.addEventListener("click", () => {
  //       if (activeUserId)
  //         window.location.href = `/admin/owner/dashboard/add-withdrawal.html?userId=${encodeURIComponent(activeUserId)}`;
  //     });
  // }
  ...
  function bindMoreModalEvents() {
    ...
    document
      .getElementById("amWithdrawalsBtn")
      ?.addEventListener("click", () => {
        if (activeUserId)
          window.location.href = `/admin/owner/dashboard/user-withdrawals.html?userId=${encodeURIComponent(activeUserId)}`;
      });
