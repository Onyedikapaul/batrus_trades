            ...
            <tr>
              <td style="padding:22px 20px;">
                ...
                <p style="margin:0 0 14px;font-size:14px;color:#475467;line-height:1.6;">
                  We received a request to reset your <b>Apex Trades</b> account password.
                ...
                ">
                  <p style="margin:0;font-size:13px;color:#92400e;line-height:1.6;">
                    ⚠️ Never share this code with anyone. Apex Trades staff will never ask for your reset code.
                  </p>
                </div>
