...
export function investmentCompletedEmailTemplate({
  name = "there",
  amount = "0",
  return_amount = "0",
  plan = "N/A",
  ...
  const safeReturn = parseFloat(return_amount).toFixed(2);
  const safePlan = String(plan || "N/A").replace(/[<>]/g, "");
  const profit = (parseFloat(return_amount) - parseFloat(amount)).toFixed(2);
            ...
            <tr>
              <td style="background:#033d75;padding:20px;">
                <div style="color:#ffffff;">
                  ...
                  <div style="font-size:12px;opacity:0.85;margin-top:4px;">Investment Completed</div>
                </div>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:22px 20px;">
                <h2 style="margin:0 0 10px;font-size:18px;letter-spacing:-0.02em;color:#101828;">
                  Your investment has matured, ${safeName}! 🎉
                </h2>
                <p style="margin:0 0 14px;font-size:14px;color:#475467;line-height:1.6;">
                  Great news! Your investment plan has completed and <b>$${safeReturn}</b> has been credited to your account balance. You can now withdraw or reinvest your earnings.
                </p>
                ...
                <div style="margin:18px 0;padding:18px;background:#f6f8fb;border:1px solid rgba(0,0,0,0.10);border-radius:14px;">
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td style="font-size:13px;color:#667085;padding:5px 0;">Amount Invested</td>
                      <td style="font-size:13px;color:#101828;font-weight:700;text-align:right;">$${safeAmount}</td>
                    </tr>
                    <tr>
                      <td style="font-size:13px;color:#667085;padding:5px 0;">Profit Earned</td>
                      <td style="font-size:13px;color:#065f46;font-weight:700;text-align:right;">+$${profit}</td>
                    </tr>
                    <tr>
                      <td style="font-size:13px;color:#667085;padding:5px 0;border-top:1px solid rgba(0,0,0,0.07);padding-top:10px;">Total Credited</td>
                      <td style="font-size:15px;color:#033d75;font-weight:800;text-align:right;border-top:1px solid rgba(0,0,0,0.07);padding-top:10px;">$${safeReturn}</td>
                    </tr>
                    <tr>
                      <td style="font-size:13px;color:#667085;padding:5px 0;">Status</td>
                      <td style="text-align:right;">
                        <span style="font-size:12px;font-weight:600;color:#065f46;background:#d1fae5;padding:2px 10px;border-radius:20px;">Completed</span>
                      </td>
                    </tr>
                  </table>
                </div>
                ...
                <p style="margin:0;font-size:13px;color:#667085;line-height:1.6;">
                  Thank you for investing with Batrus Trades. Log in to your dashboard to manage your funds.
                </p>
              </td>
            </tr>
